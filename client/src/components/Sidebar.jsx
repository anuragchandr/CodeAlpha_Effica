...
function Sidebar() {
  const quotes = [
    ...
    {
      text: "A daily routine built on good habits and disciplines separates the most successful among us from everyone else.",
      author: "Hal Elrod"
    },
    {
      ...
      <div className="parent">
        <div className="card">
          ...
          <div className="content">
            <span className="title">{currentQuote.author}</span>
            <span className="text">
              {currentQuote.text}
            </span>
          </div>
